...
public class Example2d extends Object {
	...
	protected static void perform(double[][] sourceData, double[][][] yuvMatrixes) {
		...
		aPanel.add(aView);
		Example2d.write(imageSourceData);
		...
		aView = new PaneView(aModel, new PaneController());
		aPanel.add(aView);
		Example2d.write(imageInverseData);
